                                        ...
                                        <div class="Notification_body">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="index.html#"><img src="{{ asset('assets/img/staf/2.png') }} "
                                                            alt=""></a>
                                                </div>
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="index.html#"><img src="{{ asset('assets/img/staf/4.png') }} "
                                                            alt=""></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="index.html#">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="index.html#"><img src="{{ asset('assets/img/staf/3.png') }} "
                                                            alt=""></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="index.html#">
